...
void main() {
  test('Verify ChatRepository Message Insertion and Retrieval', () async {
    ...
    try {
      ...
      print(
        'Authenticated successfully as: ${response.user?.email} (ID: $userId)',
      );
